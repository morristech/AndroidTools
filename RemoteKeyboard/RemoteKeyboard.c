 ...
 *
 * Unfortunately, I had to use conio to accomplish it, so this program
 * will only compile on Windows/DOS. If you're feeling adventurous, feel free
 * to attempt to port it to ncurses or something of that sort.
 *
